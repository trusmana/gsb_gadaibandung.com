...
class UploadPKForm(forms.Form):
    berkas_pk = forms.FileField()
...
class PencarianSopForm(forms.Form):
    cari = chosenforms.ChosenModelChoiceField(queryset=Master_Sop.objects.filter(status_sop =2),widget=chosenforms.ChosenMultipleChoiceField({'class': 'kode_barang','size': 22,}))
           

class TambahSopForm(forms.Form):
    judul_sop = forms.CharField(max_length=35,widget=forms.TextInput(attrs={'placeholder':'Judul','class': 'r_nama'}))
    tanggal_sop = forms.DateField(widget=forms.TextInput(attrs={'placeholder':'(Tanggal-Bulan-Tahun)'}))
    status_sop = forms.ChoiceField(widget=forms.Select(attrs={'readonly':'True'}),choices=AKTIFASI_PARAMETER,initial='2')

    gambar = forms.FileField()
    judul = forms.CharField(max_length=35,widget=forms.TextInput(attrs={'placeholder':'Judul','class': 'r_nama'}))
    deskripsi = forms.CharField(max_length=35,widget=forms.TextInput(attrs={'placeholder':'Deskripsi','class': 'r_nama'}))
    no_urut = forms.IntegerField(widget=forms.TextInput(attrs={'size': 2,'value':0}))
    tanggal = forms.DateField(widget=forms.TextInput(attrs={'placeholder':'(Tanggal-Bulan-Tahun)'}))
...
class AkadGadaiForm(ModelForm):
    ...
    taksir = forms.ModelChoiceField(queryset=Taksir.objects.filter(status = 2),empty_label="--- PILIH ---")
...
class PelunasanForm(forms.Form):
    ...
    nilai = forms.IntegerField(widget=forms.TextInput(attrs={'readonly':'True','size': 9, 'alt': 'integer', 'class': 'rp_nilai uang','onfocus':'total_dibayar()'}))
    ...
    bea_jasa = forms.IntegerField(widget=forms.TextInput(attrs={'size': 9, 'value': '0', 'alt': 'integer', 'class': 'rp_nilai uang','onfocus':'total_dibayar()'}))
    jenis_barang =forms.ChoiceField(choices=CHOICES_JENIS_TRANSAKSI,widget=forms.RadioSelect(attrs={'class':'rad','onfocus':'total_dibayar()'}))
    denda_kendaraan = forms.IntegerField(widget=forms.TextInput(attrs={'readonly':'True','size': 9, 'value': '0', 'alt': 'integer', 'class': 'rp_nilai uang','onfocus':'total_dibayar()'}))
    ...
    total = forms.IntegerField(widget=forms.TextInput(attrs={'size': 9, 'alt': 'integer', 'class': 'rp_nilai uang','readonly':True,'onfocus':'total_dibayar()'}))
    total_kendaraan = forms.IntegerField(widget=forms.TextInput(attrs={'size': 9, 'alt': 'integer', 'class': 'rp_nilai uang','readonly':True,'onfocus':'total_dibayar()','value':0}))
...
class AGForm(forms.Form):
    ...
    kelurahan_ktp = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20}),required=True)
    kecamatan_ktp = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20}),required=True)
    kotamadya_ktp = forms.CharField(max_length=100,widget=forms.TextInput( attrs={'size': 20}),required=True)
    kabupaten_ktp = forms.CharField(max_length=100,widget=forms.TextInput( attrs={'size': 20}),required=True)
    ##Domisili
    alamat_domisili = forms.CharField(widget=forms.TextInput(attrs={'size': 100}))
    ...
    kelurahan_domisili = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20}),required=True)
    kecamatan_domisili = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20}),required=True)
    kotamadya_domisili = forms.CharField(max_length=100,widget=forms.TextInput( attrs={'size': 20}),required=True)
    kabupaten_domisili = forms.CharField(max_length=100,widget=forms.TextInput( attrs={'size': 20}),required=True)
    ###SIM
    ...
    kelurahan_sim = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20,'value': '0'}))#,required=True)
    kecamatan_sim = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'size': 20,'value': '0'}))#,required=True)
    ...
    # Data Pasangan
    nama_pasangan = forms.CharField(max_length=35,widget=forms.TextInput(attrs={'placeholder':'Nama Pasangan','class': 'r_nama'}),required=True)
    alamat_pasangan = forms.CharField(widget=forms.TextInput(attrs={'size': 30}),required=True)
    jekel_pasangan = forms.ChoiceField(widget=forms.Select(), choices=KELAMIN,required=True)
    tlp_pasangan = forms.CharField(max_length=13,required=True,widget=forms.TextInput(attrs={'size':30}))
    no_rumah_pas = forms.CharField(max_length=4,required=True,widget=forms.TextInput(attrs={'size':5,'placeholder':'Nomor',}))
    no_rt_pas = forms.CharField(max_length=4,widget=forms.TextInput(attrs={'size':4,'placeholder':'RT',}),required=True)
    no_rw_pas = forms.CharField(max_length=4,widget=forms.TextInput(attrs={'size':4,'placeholder':'RW',}),required=True)
    ...
    fungsi_sistem = forms.CharField(max_length=70,widget=forms.TextInput(attrs={'value': '0'}))
    ...
    warna_kendaraan = forms.CharField(max_length=30,widget=forms.TextInput(attrs={'value': '0'}))
    ...
    jenis_transaksi =forms.ChoiceField(choices=CHOICES_JENIS_TRANSAKSI,widget =forms.RadioSelect(renderer=HorizRadioRenderer,attrs={'class':'rad','id':'jenis_transaksi'}), initial='1')
    ...
    fungsi_sistem = forms.CharField(label="FUNGSI SYSTEM ", widget=forms.TextInput( attrs={'size': 30,'class':'formhp formbarang ','value': '0'}))
