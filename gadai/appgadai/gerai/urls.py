...
urlpatterns = patterns('',
    ...
    url(r'^keluar/$',keluar),
    url(r'^status_pencairan_gerai/$', status_pencairan_gerai),
    url(r'^filter_rekap/$',filter_rekap),
    url(r'^cetak_status_barang/$',cetak_status_barang),
    url(r'^status_barang_gerai/$',status_barang_gerai),
    url(r'^plan_gerai/$',plan_jatuh_tempo_gerai),
