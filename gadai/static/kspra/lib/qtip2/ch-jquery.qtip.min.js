        ...
        d.checks.modal = {
            ...
            init: function() {
                ...
                q = e.create(), i.attr(n, b).css("z-index", g.modal.zindex + a(m + "[" + n + "]").length).unbind(k).unbind(l).bind("tooltipshow" + k + " tooltiphide" + k, function(b, c, d) {
                    ...
                    if (b.target === i[0])
                        if (f && b.type === "tooltiphide" && /mouse(leave|enter)/.test(f.type) && a(f.relatedTarget).closest(q[0]).length) try {
                            b.preventDefault()
            ...
            toggle: function(d, g, h) {
                ...
                g ? (q.css({
                    ...
                    var d = a(b.target),
                        e = d.closest(".qtip"),
                        f = e.length < 1 ? c : parseInt(e[0].style.zIndex, 10) > parseInt(i[0].style.zIndex, 10);
